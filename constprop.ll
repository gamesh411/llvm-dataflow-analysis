; ModuleID = 'constprop.c'
source_filename = "constprop.c"
...
define dso_local void @ralph(i32 %0, i32 %1, i32 %2) #0 !dbg !7 {
  ...
  %8 = load i32, i32* %5, align 4, !dbg !18
  %9 = load i32, i32* %6, align 4, !dbg !19
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 %7, i32 %8, i32 %9), !dbg !20
  ret void, !dbg !21
}
...
define dso_local i32 @main() #0 !dbg !22 {
  ...
  call void @ralph(i32 10, i32 100, i32 1000), !dbg !25
  ret i32 0, !dbg !26
}
...
!1 = !DIFile(filename: "constprop.c", directory: "/home/gamesh411/llvm-dataflow-analysis")
!2 = !{}
...
!19 = !DILocation(line: 7, column: 32, scope: !7)
!20 = !DILocation(line: 7, column: 3, scope: !7)
!21 = !DILocation(line: 8, column: 1, scope: !7)
!22 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 11, type: !23, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!23 = !DISubroutineType(types: !24)
!24 = !{!10}
!25 = !DILocation(line: 12, column: 3, scope: !22)
!26 = !DILocation(line: 13, column: 3, scope: !22)
