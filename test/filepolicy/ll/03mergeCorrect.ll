; ModuleID = '<stdin>'
source_filename = "c/03mergeCorrect.c"
...
if.else:                                          ; preds = %entry
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0)), !dbg !84
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call3 = call i32 @fclose(%struct._IO_FILE* %call), !dbg !86
  ret i32 0, !dbg !87
}
...
!1 = !DIFile(filename: "c/03mergeCorrect.c", directory: "/home/gamesh411/llvm-dataflow-analysis/test/filepolicy")
!2 = !{}
