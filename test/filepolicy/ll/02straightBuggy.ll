; ModuleID = '<stdin>'
source_filename = "c/02straightBuggy.c"
...
entry:
  ...
  %call1 = call i32 @fclose(%struct._IO_FILE* %call), !dbg !78
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0)), !dbg !79
  ret i32 0, !dbg !80
}
...
!1 = !DIFile(filename: "c/02straightBuggy.c", directory: "/home/gamesh411/llvm-dataflow-analysis/test/filepolicy")
!2 = !{}
