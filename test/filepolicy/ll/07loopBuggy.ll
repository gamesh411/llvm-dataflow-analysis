; ModuleID = '<stdin>'
source_filename = "c/07loopBuggy.c"
...
@conds = external dso_local global [10 x i32], align 16
...
entry:
  ...
  call void @llvm.dbg.value(metadata i32 10, metadata !82, metadata !DIExpression()), !dbg !81
  br label %for.cond, !dbg !83

for.cond:                                         ; preds = %for.inc, %entry
  %outfile.0 = phi %struct._IO_FILE* [ %call, %entry ], [ %call3, %for.inc ], !dbg !77
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !dbg !81
  call void @llvm.dbg.value(metadata i32 %i.0, metadata !78, metadata !DIExpression()), !dbg !81
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %outfile.0, metadata !14, metadata !DIExpression()), !dbg !77
  %cmp = icmp ne i32 %i.0, 10, !dbg !84
  br i1 %cmp, label %for.body, label %for.end, !dbg !86

for.body:                                         ; preds = %for.cond
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %outfile.0, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0)), !dbg !87
  %call2 = call i32 @fclose(%struct._IO_FILE* %outfile.0), !dbg !89
  %call3 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !90
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %call3, metadata !14, metadata !DIExpression()), !dbg !77
  %idxprom = zext i32 %i.0 to i64, !dbg !91
  %arrayidx = getelementptr inbounds [10 x i32], [10 x i32]* @conds, i64 0, i64 %idxprom, !dbg !91
  %0 = load i32, i32* %arrayidx, align 4, !dbg !91
  %tobool = icmp ne i32 %0, 0, !dbg !91
  br i1 %tobool, label %if.then, label %if.end, !dbg !93

if.then:                                          ; preds = %for.body
  %call4 = call i32 @fclose(%struct._IO_FILE* %call3), !dbg !94
...
for.inc:                                          ; preds = %if.end
  %inc = add i32 %i.0, 1, !dbg !98
  call void @llvm.dbg.value(metadata i32 %inc, metadata !78, metadata !DIExpression()), !dbg !81
  br label %for.cond, !dbg !99, !llvm.loop !100

for.end:                                          ; preds = %for.cond
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %outfile.0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)), !dbg !103
  %call6 = call i32 @fclose(%struct._IO_FILE* %outfile.0), !dbg !104
  ret i32 0, !dbg !105
}
...
!1 = !DIFile(filename: "c/07loopBuggy.c", directory: "/home/gamesh411/llvm-dataflow-analysis/test/filepolicy")
!2 = !{}
...
!78 = !DILocalVariable(name: "i", scope: !79, file: !1, line: 9, type: !80)
!79 = distinct !DILexicalBlock(scope: !9, file: !1, line: 9, column: 3)
!80 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!81 = !DILocation(line: 0, scope: !79)
!82 = !DILocalVariable(name: "e", scope: !79, file: !1, line: 9, type: !80)
!83 = !DILocation(line: 9, column: 8, scope: !79)
!84 = !DILocation(line: 9, column: 34, scope: !85)
!85 = distinct !DILexicalBlock(scope: !79, file: !1, line: 9, column: 3)
!86 = !DILocation(line: 9, column: 3, scope: !79)
!87 = !DILocation(line: 10, column: 5, scope: !88)
!88 = distinct !DILexicalBlock(scope: !85, file: !1, line: 9, column: 45)
!89 = !DILocation(line: 11, column: 5, scope: !88)
!90 = !DILocation(line: 12, column: 15, scope: !88)
!91 = !DILocation(line: 13, column: 9, scope: !92)
!92 = distinct !DILexicalBlock(scope: !88, file: !1, line: 13, column: 9)
!93 = !DILocation(line: 13, column: 9, scope: !88)
!94 = !DILocation(line: 14, column: 7, scope: !95)
!95 = distinct !DILexicalBlock(scope: !92, file: !1, line: 13, column: 19)
!96 = !DILocation(line: 15, column: 5, scope: !95)
!97 = !DILocation(line: 16, column: 3, scope: !88)
!98 = !DILocation(line: 9, column: 40, scope: !85)
!99 = !DILocation(line: 9, column: 3, scope: !85)
!100 = distinct !{!100, !86, !101, !102}
!101 = !DILocation(line: 16, column: 3, scope: !79)
!102 = !{!"llvm.loop.mustprogress"}
!103 = !DILocation(line: 18, column: 3, scope: !9)
!104 = !DILocation(line: 19, column: 3, scope: !9)
!105 = !DILocation(line: 20, column: 3, scope: !9)
